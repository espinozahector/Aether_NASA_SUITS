...
#region Hololens Events
    ...
    void GC_OnConnected() {
        Debug.Log("Connected");
        //Notification.Issue("Controller Conection", "The controller has successfully connected", 0);
    }

    void GC_OnDisconnected() {
        Debug.Log("Disconnected");
        //Notification.Issue("Controller Conection", "The controller has disconnected", 0);
    }
